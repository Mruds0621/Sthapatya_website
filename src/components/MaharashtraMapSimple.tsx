...
export function MaharashtraMapSimple({ selectedDistrict, onDistrictClick }: MaharashtraMapSimpleProps) {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <div className="bg-gradient-to-br from-[#4f46e5]/5 to-[#1e3a8a]/5 border border-[#4f46e5]/20 p-6 h-full flex flex-col">
        <h3 className="text-xl text-[#1e3a8a] mb-4 text-center">Our Presence in Maharashtra</h3>
        ...
        <p className="text-xs text-[#14B8A6]/60 text-center mt-3">Click on any district to view details</p>
      </div>
    </motion.div>
  );
}
