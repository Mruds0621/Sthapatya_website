    ...
    <div className="relative w-full overflow-x-hidden">
      <div className="flex items-center min-h-[700px] overflow-hidden">
        ...
        <div className="relative w-[1000px] h-[800px] -ml-[500px] flex-shrink-0">
          ...
          {/* Flower Center - Round circle at the center - ENLARGED */}
          <motion.div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full flex items-center justify-center z-60"
            style={{
              width: '260px',
              height: '260px',
              background: 'radial-gradient(circle, #FBBF24 0%, #F59E0B 60%, #D97706 100%)',
              boxShadow: '0 25px 80px rgba(245, 158, 11, 0.6), inset 0 -15px 40px rgba(0, 0, 0, 0.2)',
            }}
          ...
          >
            ...
            <div 
              ...
              style={{
                ...
                boxShadow: 'inset 0 3px 20px rgba(0, 0, 0, 0.2)',
              }}
            />
            
            {/* Logo area - white center - ENLARGED */}
            <div 
              className="absolute inset-12 rounded-full bg-white flex items-center justify-center overflow-visible"
              style={{
            ...
            {/* Decorative dots around center - ADJUSTED FOR LARGER SIZE */}
            {[...Array(16)].map((_, i) => {
              const dotAngle = (360 / 16) * i;
              return (
                <motion.div
                  key={i}
                  ...
                  style={{
                    top: '50%',
                    left: '50%',
                    transform: `translate(-50%, -50%) rotate(${dotAngle}deg) translateY(-125px)`,
            ...
            {/* Inner decorative circle pattern - ADJUSTED FOR LARGER SIZE */}
            {[...Array(8)].map((_, i) => {
              const smallDotAngle = (360 / 8) * i;
              return (
                <div
                  key={`inner-${i}`}
                  ...
                  style={{
                    top: '50%',
                    left: '50%',
                    transform: `translate(-50%, -50%) rotate(${smallDotAngle}deg) translateY(-90px)`,
                  }}
                />
              );
            })}
